...
RUN --mount=type=cache,id=s/f1e825c9-818d-4067-80d5-96d3d5156631-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store \
...
RUN --mount=type=cache,id=s/f1e825c9-818d-4067-80d5-96d3d5156631-/var/cache/apt,target=/var/cache/apt \
    --mount=type=cache,id=s/f1e825c9-818d-4067-80d5-96d3d5156631-/var/lib/apt,target=/var/lib/apt \
    apt-get update && \
